...
--
-- Logique (identique a insert_impact_financier() dans gold.py de _projet) :
...
--   dbt construira ces deux modeles avant celui-ci (DAG automatique).
--
-- Materalisation : table dans le schema gold (alias = impact_financier)
