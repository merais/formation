...
print("End of listener ...")
    ...
    # print(f"✅ Nouvelle commande #{payload['order_id']} le {payload['order_date']} : "
    #         f"{payload['quantity_sold']} {payload['product_name']} vendus "
    #         f"({payload['total_sales']} €) dans la région {payload['region']}.")