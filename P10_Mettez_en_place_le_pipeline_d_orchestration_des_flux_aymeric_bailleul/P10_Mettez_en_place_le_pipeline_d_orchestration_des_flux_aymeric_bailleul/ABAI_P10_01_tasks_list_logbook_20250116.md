...
- [X] Préparer la démonstration de l'interface Kestra
- [X] Préparer la démonstration des résultats (fichiers générés)
- [X] Préparer les réponses aux questions techniques anticipées
- [X] S'entraîner à la présentation complète (15-20 minutes)

#### 6.4 Livrables finaux
- [X] Vérifier la complétude de tous les livrables
- [X] Finaliser le fichier .yaml Kestra
- [X] Finaliser le diagramme Draw.io (PNG + .drawio)
- [X] Finaliser le support de présentation
- [X] Remplir la fiche d'autoévaluation
- [X] Préparer le dernier mentorat de validation
