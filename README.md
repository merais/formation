...
|Numéro | Nom | Date de début |
| :-----------------------------: | :-------------------------------------- | :----------------:|
|P1  | Découvrez votre formation de Data Engineer 											| 10/08/2025|
|P2  | Analysez les données de systèmes éducatifs 											| 24/08/2025|
|P3  | Entraînez-vous avec SQL et créez votre BDD 											| 06/09/2025|
|P4  | Auditez un environnement de données													| 24/09/2025|
|P5  | Maintenez et documentez un système de stockage des données sécurisé et performant 	| 13/10/2025|
|P6  | Anticipez les besoins en consommation de bâtiments 									| 04/11/2025|
|P7  | Concevez et analysez une base de données NoSQL 										| 27/11/2025|
|P8  | Construisez et testez une infrastructure de données 								    | 19/12/2025|
|P9  | Modélisez une infrastructure dans le cloud 											| 15/01/2026|
|P10 | Mettez en place le pipeline d'orchestration des flux 								| 16/02/2026|
|P11 | Catégorisez automatiquement des questions 											| 10/03/2026|
|P12 | Gérez un projet d'infrastructure 													| 11/04/2026|
|P13 | Réalisez votre portfolio de Data Engineer 											| 04/05/2026|
---
