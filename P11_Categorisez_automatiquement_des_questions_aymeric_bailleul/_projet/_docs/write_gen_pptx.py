"""Script helper — réécrit gen_pptx.py avec le contenu vulgarisé."""
...
target = Path(__file__).parent / "gen_pptx.py"
target.write_text(CONTENT, encoding="utf-8")
print(f"OK — {len(CONTENT)} chars écrits dans {target.name}")
