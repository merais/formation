...
echo ============================================================ > "!LOG_FILE!"
echo  FULL TESTS RAG  -  %date% %time% >> "!LOG_FILE!"
echo ============================================================ >> "!LOG_FILE!"
echo. >> "!LOG_FILE!"

.venv\Scripts\python.exe -m pytest tests\ -v 2>&1 | powershell -NoProfile -Command "$input | Tee-Object -Append -FilePath '!LOG_FILE!'"
